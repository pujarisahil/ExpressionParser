...
public class Utils {
	...
	public static void printAtom(ExpressionAtom atom) {
		if (atom.getAtomType() == AtomType.OPERAND) {
			if (atom.getCoefficient() == 1
					&& atom.getVariablesOrOperator() != "") {
	...
	public static void printListRepresentation(ListRepresentation listExpression) {
		...
		if (listExpression.operands.isEmpty()) {
			...
			System.out.print(listExpression.getNodeVal()
	...
	public static List<List<ExpressionAtom>> add(List<List<ExpressionAtom>> list) {
